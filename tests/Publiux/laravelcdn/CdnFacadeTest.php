...
class CdnFacadeTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->provider = M::mock('Eliurkis\laravelcdn\Providers\AwsS3Provider');

        $this->provider_factory = M::mock('Eliurkis\laravelcdn\Contracts\ProviderFactoryInterface');
        $this->provider_factory->shouldReceive('create')->once()->andReturn($this->provider);

        $this->helper = M::mock('Eliurkis\laravelcdn\Contracts\CdnHelperInterface');
        ...
        $this->validator = new \Eliurkis\laravelcdn\Validators\CdnFacadeValidator();

        $this->facade = new \Eliurkis\laravelcdn\CdnFacade(
    ...
    /**
     * @expectedException \Eliurkis\laravelcdn\Exceptions\EmptyPathException
     */
