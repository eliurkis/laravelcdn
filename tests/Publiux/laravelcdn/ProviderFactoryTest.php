...
class ProviderFactoryTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->provider_factory = new \Eliurkis\laravelcdn\ProviderFactory();
    }
    ...
    public function testCreateReturnCorrectProviderObject()
    {
        ...
        $m_aws_s3 = M::mock('Eliurkis\laravelcdn\Providers\AwsS3Provider');
    ...
    /**
     * @expectedException \Eliurkis\laravelcdn\Exceptions\MissingConfigurationException
     */
