...
use Eliurkis\laravelcdn\Contracts\CdnFacadeInterface;
use Eliurkis\laravelcdn\Contracts\CdnHelperInterface;
use Eliurkis\laravelcdn\Contracts\ProviderFactoryInterface;
use Eliurkis\laravelcdn\Exceptions\EmptyPathException;
use Eliurkis\laravelcdn\Validators\CdnFacadeValidator;
...
class CdnFacade implements CdnFacadeInterface
{
     ...
     *
     * @var \Eliurkis\laravelcdn\Providers\Contracts\ProviderInterface
     */
    protected $provider;
    ...
    /**
     * @var \Eliurkis\laravelcdn\Validators\CdnFacadeValidator
     */
     ...
     *
     * @param \Eliurkis\laravelcdn\Contracts\ProviderFactoryInterface $provider_factory
     * @param \Eliurkis\laravelcdn\Contracts\CdnHelperInterface       $helper
     * @param \Eliurkis\laravelcdn\Validators\CdnFacadeValidator      $cdn_facade_validator
     */
