...
use Eliurkis\laravelcdn\Exceptions\UnsupportedProviderException;
...
{
    const DRIVERS_NAMESPACE = 'Eliurkis\\laravelcdn\\Providers\\';
     ...
     *
     * @throws \Eliurkis\laravelcdn\UnsupportedDriverException
     *
     * @return mixed
     */
